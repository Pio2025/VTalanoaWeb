...
<main>
  ...
  <section class="wrap hero">
    ...
    <!-- Mock meeting window -->
    <div class="meet" role="img" aria-label="Preview of a VTalanoa video call with four participants">
      <div class="meet-top">
  ...
  <section class="wrap section" id="features">
    <div class="section-head">
      ...
      <p>From quick catch-ups to all-hands meetings, VTalanoa keeps every conversation simple, secure, and free to start.</p>
    </div>
    <div class="cards">
      <article class="card">
      ...
      <article class="card">
        ...
        <p>Start on your laptop, continue on your phone. VTalanoa runs in the browser and as an app on Windows, Mac, iOS, and Android.</p>
      </article>
    </div>
  </section>
