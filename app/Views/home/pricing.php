...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  /* ---------- Footer ---------- */
  footer{margin-top:auto;border-top:1px solid var(--line);background:rgba(255,255,255,.55);backdrop-filter:blur(8px)}
...
<main>
  ...
  <div class="wrap note-strip">
    <p>All paid plans are billed monthly. Need a custom plan for a large organisation? <a href="#">Contact us</a>.</p>
  </div>
</main>
