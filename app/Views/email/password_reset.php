...
<style>
  ...
  .note { background:#f8fafc; border-left:4px solid #1c75bc; border-radius:4px; padding:12px 16px; font-size:13px; color:#64748b; margin-top:20px; }
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <p style="margin-top:20px;font-size:13px;color:#94a3b8;">
      ...
      <a href="<?= esc($rl) ?>" style="color:#1c75bc;word-break:break-all;"><?= esc($rl) ?></a>
    </p>
  </div>
  <div class="footer">
